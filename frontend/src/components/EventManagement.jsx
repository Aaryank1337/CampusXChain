    ...
    const EventCard = ({ event }) => (
        <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
            <div className="flex justify-between items-start mb-4">
                ...
                <span className={`px-3 py-1 rounded-full text-sm font-medium ${event.status === 'upcoming' ? 'bg-blue-100 text-blue-800' :
            ...
            <div className="flex justify-between items-center mb-8">
                ...
                {!isOwner ? (
                    <div className="bg-yellow-600/20 text-yellow-200 p-3 rounded-lg text-sm">
                        Only contract owner can perform Event Creation
                    </div>
                ) : (
